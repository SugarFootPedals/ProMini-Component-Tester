...
//#define EBC_STYLE
  ...
  #define LCD_CHAR_U      0x75  
  #define LCD_CHAR_OMEGA  0x00
...
//   const unsigned char Diode[] MEM_TEXT = "Diode: ";
  ...
  const unsigned char TestFailed2[] MEM_TEXT = "Fail,";
  const unsigned char Component[] MEM_TEXT = "NoPart";
  //const unsigned char Diode[] MEM_TEXT = "Diode: ";
  const unsigned char Triac[] MEM_TEXT = "Triac";
  const unsigned char Thyristor[] MEM_TEXT = "Thyristor";
  const unsigned char Unknown[] MEM_TEXT = "Unknown";
  const unsigned char TestFailed1[] MEM_TEXT = "Unknown,";
  const unsigned char OrBroken[] MEM_TEXT = "Damaged";
  const unsigned char TestTimedOut[] MEM_TEXT = "Timeout!";
...
const unsigned char CapZeich[] MEM_TEXT = {"--||--"};
const unsigned char Cell_str[] MEM_TEXT = "Charged!";
...
const unsigned char VERSION_str[] MEM2_TEXT = "Wait";

const unsigned char AnKat[] MEM_TEXT = {"A-->|-C"};
const unsigned char KatAn[] MEM_TEXT = {"C-|<--A"};
...
const unsigned char OmegaIcon[]  MEM_TEXT = { 0x00, 0x6F, 0x68, 0x6D, 0x00 }; // Omega Icon
...
// Makros for LCD
#define lcd_line1() lcd_set_cursor(0,1)  // move to beginning of 1 row
#define lcd_line2() lcd_set_cursor(1,1)  // move to beginning of 2 row
#define lcd_line3() lcd_set_cursor(2,1)  // move to beginning of 3 row
#define lcd_line4() lcd_set_cursor(3,1)  // move to beginning of 4 row
